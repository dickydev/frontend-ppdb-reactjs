...
const HasilForm = ({ title, judul, data1, children, to }) => {
    ...
    return (
        <div className='pt-2'>
            ...
            {/* <Link to={to} className='flex items-center justify-center size-[50px] bg-gray-100 rounded-full absolute left-4 top-4 '><FaAngleLeft /></Link> */}
